        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedYearLevels = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AllowedSections = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AllowedCourses = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationsData", x => x.Id);
                    table.ForeignKey(
